...
const CheckInSuccess = ({ route, navigation }) => {
    ...
    <>
      <View style={styles.root}>
        <View style={styles.container}>
          ...
          <View style={tailwind('flex flex-row justify-between')}>
            <View>
              <Text
                style={tailwind('text-left pl-3 pt-3 text-xs text-gray-700')}
              >
                Nama
              </Text>
              <Text style={tailwind('text-left pl-3 text-sm text-black')}>
      ...
      <View style={tailwind('absolute bottom-0 w-full bg-white')}>
        <Button
          title="Check-Out"
          color="white"
          style={tailwind('mx-5 my-2 h-10 w-11/12')}
          textStyle={tailwind(' font-bold ')}
